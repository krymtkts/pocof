            ...
            testList
                ...
                [
                    ...
                    test "When rendering head 40 of query when cursor 0 with full-width characters" {
                        ...
                        rui.screen
                        |> Expect.equal
                            "should render head 40 of query when cursor 0 with full-width characters"
                            expected
                    }
                    ...
                    test "When rendering head 40 of query when cursor 39 with full-width characters" {
                        ...
                        rui.screen
                        |> Expect.equal
                            "should render head 40 of query when cursor 39 with full-width characters"
                            expected
                    }
                    ...
                    test "When rendering mid 40 of query when cursor 53 with full-width characters" {
                        ...
                        rui.screen
                        |> Expect.equal
                            "should render mid 40 of query when cursor 53 with full-width characters"
                            expected
                    }
                    ...
                    test "When rendering tail 40 of query when cursor 90 with full-width characters" {
                        ...
                        rui.screen
                        |> Expect.equal
                            "should render tail 40 of query when cursor 90 with full-width characters"
                            expected
                    }
